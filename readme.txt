...
Doing this task manually, this is, by copy-pasting each required field into a spreadsheet, would mean doing this 195 (foundations) * 11 (fields) = 2145 times. So my next thought was to automate the procedure by scraping the CFC website. Fortunately, all that information is included in their website in a straightforward schema.
